...
import { events as trips } from "../data/eventData";
      ...
      <div className="trip-not-found">
        <Container>
          <div className="not-found-content">
            ...
            <Button onClick={() => navigate("/events")} className="btn-back-to-trips">
  ...
  return (
    <div className="trip-detail-page">
                ...
                <div className="booking-card">
                  ...
                  <div className="details-list">
                    ...
                    <div className="detail-row">
                      ...
                      <span className="detail-value">{trip.venue}</span>
                    </div>
                    <div className="detail-row">
                      <span className="detail-label">
                        <FiFilter /> Level
      ...
      <section className="similar-trips">
        <Container>
          <h2 className="section-title">More Events Await</h2>
          <p className="section-subtitle">
            Check out these similar events you might love
          </p>
